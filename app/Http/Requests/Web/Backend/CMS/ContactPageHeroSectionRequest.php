...
class ContactPageHeroSectionRequest extends FormRequest {
    /**
    ...
    public function rules(): array {
        return [
            ...
            'banner'        => 'nullable|image|mimes:jpg,jpeg,png,gif,webp|max:20480',
    ...
    public function messages(): array {
        return [
            ...
            'banner.image'     => 'The banner file must be an image.',
            'banner.mimes'     => 'The banner must be a file of type: jpg, jpeg, png, gif, webp.',
