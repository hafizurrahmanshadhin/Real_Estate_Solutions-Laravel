...
@section('title', 'Contact Page | Hero Section')
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title mb-0">Contact Page Hero Section Management</h4>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="{{ route('contact-page.hero-section.update') }}"
                                ...
                                <div class="row gy-4">
                                    ...
                                    <div class="col-md-6">
                                        <div>
                                            ...
                                            <input class="form-control dropify @error('banner') is-invalid @enderror"
                                                type="file" name="banner" id="banner" accept="image/*"
                                                data-default-file="{{ $heroSection && $heroSection->getRawBannerPath() ? asset($heroSection->getRawBannerPath()) : '' }}"
...
@push('scripts')
    <script>
        $(document).ready(function() {
            // Initialize Dropify for both banner and image
            $('.dropify').dropify({
                messages: {
            ...
            // Reset remove flags when new files are selected
            $('#banner').on('change', function() {
                if (this.files && this.files.length > 0) {
                    $('input[name="remove_banner"]').val('0');
                }
            });
